/**
 * Fleischfresser-Alphas - Globales Format
 */
...
window.CarnivoreAlphas = {
  ...
  "Jaguarundi": {
    ...
    "skills": {
      ...
      "skill2": { "name": "Bestien-Verteidigung", "type": "passive_stat", "effects": [{ "type": "def_bonus", "value": 0.38 }] },
      "skill3": { "name": "Bestien-Angriff", "type": "passive_stat", "effects": [{ "type": "atk_bonus", "value": 0.38 }] },
      "skill4": { "name": "Schwachstellenfang", "type": "trigger", "trigger": "after_normal_attack", "chance": 0.70, "range": 4, "effects": [{ "target": "enemy_front_row", "type": "alpha_damage", "multiplier": 2.50 }, { "target": "enemy_front_row", "type": "debuff_increase_taken_skill_dmg", "value": 0.30 }] },
  ...
  "WeisserLoewe": {
    ...
    "class": "Fleischfresser",
    "skills": {
      "skill1": { "name": "Heftiger Angriff", "type": "trigger", "trigger": "after_normal_attack", "chance": 0.60, "range": 5, "effects": [{ "target": "enemy_front_row", "type": "alpha_damage", "multiplier": 3.00 }] },
      "skill2": { "name": "Bestien-Verteidigung", "type": "passive_stat", "effects": [{ "type": "def_bonus", "value": 0.38 }] },
      "skill3": { "name": "Bestien-Angriff", "type": "passive_stat", "effects": [{ "type": "atk_bonus", "value": 0.38 }] },
      "skill4": { "name": "Aggressiver Biss", "type": "trigger", "trigger": "after_normal_attack", "chance": 0.60, "range": 5, "effects": [{ "target": "two_random_enemy_rows", "type": "alpha_damage", "multiplier": 2.50 }] },
      "skill5": { "name": "Bestien-Angriff", "type": "passive_stat", "effects": [{ "type": "atk_bonus", "value": 0.38 }] },
  ...
  "Titanis": {
    ...
    "class": "Fleischfresser",
    "skills": {
      "skill1": { "name": "Kraft des Raubvogels", "type": "pre_battle", "duration": 3, "effects": [{ "target": "all_friendly_flesh_eaters", "type": "atk_buff_percentage", "value": 0.80 }] },
      ...
      "skill4": { "name": "Spritzen-Schlag", "type": "pre_battle", "duration": 3, "chance": 0.75, "effects": [{ "target": "all_friendly_flesh_eaters", "type": "apply_splash_damage", "multiplier": 1.00 }] },
      "skill5": { "name": "Basis-LP", "type": "passive_stat", "effects": [{ "type": "def_bonus", "value": 0.20 }] },
      "skill6": { "name": "Wütende Vergeltung", "type": "pre_battle", "duration": 3, "effects": [{ "target": "friendly_front_row", "type": "counter_attack", "chance": 1.00, "multiplier": 1.80 }] }
    }
  },
  "AmerikanischerLoewe": {
    "id": "amerik_loewe_01",
    "class": "Fleischfresser",
    "skills": {
      "skill1": { "name": "Instinkt der Bewahrung", "type": "active_combat", "chance": 0.70, "range": 2, "effects": [{ "target": "two_random_friendly_rows", "type": "cleanse_debuffs", "value": 1.00 }] },
      "skill2": { "name": "Bestien-Verteidigung", "type": "passive_stat", "effects": [{ "type": "def_bonus", "value": 0.48 }] },
      "skill3": { "name": "Bestien-Angriff", "type": "passive_stat", "effects": [{ "type": "atk_bonus", "value": 0.48 }] },
      "skill4": { "name": "Rasche Angriffe", "type": "pre_battle", "duration": 3, "range": 2, "effects": [{ "target": "two_random_friendly_rows", "type": "speed_buff", "value": 60 }] },
      "skill5": { "name": "Bestien-Verteidigung", "type": "passive_stat", "effects": [{ "type": "def_bonus", "value": 0.48 }] },
      "skill6": { "name": "Taktische Verfolgung", "type": "passive_trigger", "effects": [{ "target": "enemy_rows", "type": "debuff_increase_taken_damage", "value": 0.15 }] }
    }
  },
  ...
  "Hyaenodon": {
    ...
    "class": "Fleischfresser",
    "skills": {
      "skill1": { "name": "Siegesstrategie", "type": "pre_battle", "effects": [{ "target": "self_unit", "type": "conditional_buff", "condition": "first_attack", "value": 0.20 }] },
      ...
      "skill6": { "name": "Starke Heilung", "type": "active_combat", "range": 2, "effects": [{ "target": "all_friendly_rows", "type": "hp_buff", "value": 0.20 }] }
    }
  },
  "Smilodon": {
    "id": "smilodon_01",
    "class": "Fleischfresser",
    "skills": {
      "skill1": { "name": "Tödlicher Comboschlag", "type": "active_combat", "chance": 0.80, "range": 6, "effects": [{ "target": "one_random_enemy_row", "type": "alpha_damage", "multiplier": 2.00 }] },
      "skill2": { "name": "Bestien-Verteidigung", "type": "passive_stat", "effects": [{ "type": "def_bonus", "value": 0.60 }] },
      "skill3": { "name": "Bestien-Angriff", "type": "passive_stat", "effects": [{ "type": "atk_bonus", "value": 0.60 }] },
      "skill4": { "name": "Wilde Zähne", "type": "active_combat", "chance": 0.70, "range": 6, "effects": [{ "target": "three_random_enemy_rows", "type": "alpha_damage", "multiplier": 1.30 }] },
      "skill5": { "name": "Bestien-Angriff", "type": "passive_stat", "effects": [{ "type": "atk_bonus", "value": 0.60 }] },
      "skill6": { "name": "Taktischer Fernschlag", "type": "pre_battle_per_round", "chance": 0.50, "effects": [{ "type": "increase_position_distance", "value": 1 }] }
    }
  }
};
