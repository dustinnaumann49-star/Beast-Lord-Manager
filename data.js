  ...
  "Jaguarundi": {
    ...
    "skills": {
      "skill1": {
        ...
        "type": "passive_start_of_battle",
        "effects": [
          { "target": "self_row", "type": "speed_buff", "value": 100 },
          { "target": "self_row", "type": "normal_atk_dmg_buff_base", "value": 0.80 }
        ]
      },
      "skill4": {
        "name": "Schwachstellenfang",
        "type": "trigger",
        "trigger": "after_normal_attack",
        "chance": 0.70,
        "range": 4,
        "effects": [
          { "target": "enemy_front_row", "type": "alpha_damage", "multiplier": 2.50, "scaling": { "type": "per_alpha_level", "value": 0.01 } },
          { "target": "enemy_front_row", "type": "debuff_increase_taken_skill_dmg", "value": 0.30, "scaling": { "type": "per_alpha_level", "value": 0.01 } }
        ]
      },
      "skill6": {
        "name": "Schneller Stoß",
        ...
        "range": 2,
        "effects": [
          { "target": "two_random_friendly_rows", "type": "add_extra_normal_attack", "value": 1 }
        ]
      }
    }
  }
